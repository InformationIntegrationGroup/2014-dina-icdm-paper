...
% \begin{table}[h]
% 	\centering	
% 	\caption{Showing 5 columns from the LocationProbe dataset\label{tab:sample_location_data}}
%   	\begin{tabular}{ | p{1.1cm} | p{2cm} | p{2cm} | p{1cm} | p{0.732009cm} | }
%     	\hline
% 	    \textbf{timestamp} & \textbf{latitude} & \textbf{longitude} & \textbf{speed} & \textbf{accuracy} \\ \hline
% 	    1387969151 & 22.58586372 & 88.38064909 & 0 & 32 \\ \hline
% 		1387969185 & 22.5858598 & 88.37985344 & 0 & 12 \\ \hline
% 		1387969186 & 22.58581108 & 88.37984354 & 0.80203056 & 12 \\ \hline
% 		1387969282 & 22.58534547 & 88.37977455 & 1.0898862 & 24 \\
% 	    \hline
%   	\end{tabular}
% \end{table}

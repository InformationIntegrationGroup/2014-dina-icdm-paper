...
import web
import csv
import postDFTprocessing


infile = open('forDFT.csv')
outfile = open('DataWithDFT_out.csv', 'w+')  # output file (csv)
...
resultFile = postDFTprocessing.process_DFt_output('DataWithDFT_out.csv')
